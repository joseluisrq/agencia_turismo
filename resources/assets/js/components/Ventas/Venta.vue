                            ...
                            <div class="col-md-12">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="form-inline">
                                        <button @click="abrirModal()" class="btn btn-outline-warning col-md-6"><span style="color:red;" v-show="idarticulo==0">*Seleccione paquetes</span></button>
                                ...
                                <table class="table table-bordered table-striped table-sm">
                                    ...
                                    <tbody v-if="arrayDetalle.length">
                                        <tr v-for="detalle in arrayDetalle" :key="detalle.id">
                                            ...
                                            <td >
                                                  <button type="button" @click="pdfDetallePaquete(detalle.idpaq)" class="btn btn-warning btn-sm">
                                                <i class="far fa-file-pdf"></i>
                                                </button> 
                                                {{detalle.articulo}}
                                            </td>
                            ...
                            <div class="form-group row">
                                 <div class="col-md-12">
                                    <div class="input-group">
                                        ...
                                        <option 
                                        <option value="codigo_paquete">Código</option>
                                        </select>
                                        <input type="text" v-model="buscarA" @keyup.enter="listarPaquetes(buscarA,criterioA)" class="form-control" placeholder="Texto a buscar">
                                        <button type="submit" @click="listarPaquetes(buscarA,criterioA)" class="btn btn-primary"><i class="fa fa-search"></i> Buscar</button>
                                    </div>
                                </div>
                            </div>
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-sm">
                                    <thead>
                                     ...
                                     <tbody>
                                        <tr v-for="servicio in arrayPaquetes" :key="servicio.id">
                                            <td>
                                                <button type="button" @click="agregarDetalleModal(servicio)" class="btn btn-success btn-sm">
                                               <i class="far fa-check-circle"></i>
                                                </button>
                                            </td>
                                            <td v-text="servicio.codigo_paquete"></td>
                                            <td v-text="servicio.nombre_paquete"></td>
...
<script>
    ...
    export default {
        ...
        methods : {
            ...
            buscarArticulo(){
                let me=this;
                var url= this.ruta + '/paquete/buscarPaqueteVenta?filtro=' + me.codigo;
                ...
                if(me.idarticulo==0 || me.cantidad==0 || me.precio==0){
                    ...
                    if(me.encuentra(me.idarticulo)){
                        swal({
                            type: 'error',
                            title: 'Error...',
                            text: 'Ese paquete ya se encuentra agregado!',
                            })
                    }
                    else{
            ...
            listarPaquetes (buscar,criterio){
                let me=this;
                var url= this.ruta + '/paquete/listarPaquetesVenta?buscar='+ buscar + '&criterio='+ criterio;
                axios.get(url).then(function (response) {
                    var respuesta= response.data;
            ...
            verVenta(id){
                ...
                axios.get(url).then(function (response) {
                    ...
                    me.cliente = arrayVentaT[0]['nombres']+''+ arrayVentaT[0]['apellidos'];
            ...
            desactivarVenta(id){
                  let me=this;
               Swal.fire({             
                title: '<span style="font-size:25px">¿Estás seguro de anular esta venta?</span>',
                icon: 'info',
