...
<html>
    ...
    <div class="zona_impresion">
        <!-- codigo imprimir -->
        <br>
        @foreach ($paqueteselecionado as $v)
        <table  align="center" width="700px">
            <tr>
                <td align="center">
                <!-- Mostramos los datos de la empresa en el documento HTML -->
                .::<strong> Campiña Tours </strong>::.<br>
                https://campitours.com/<br>
                (+51) 971298478(+51) 964041249<br>
                Jr. Dos de Mayo N° 569 - Stand 1 - Cajamarca<br>
                </td>
            </tr>
            <tr>
        ...
        <table align="center" width="700px">   
            <tr>
                <td>Nombre : {{$v->nombre_paquete}} </td>          
            </tr>  
            <tr>
                <td>Descripcion : {{$v->detalle}} </td>               
            </tr>  
            <tr>  
                <td>Atendido por : {{$v->nombres}}  {{$v->apellidos}} </td>  
            </tr>      
         </table>
         @endforeach
